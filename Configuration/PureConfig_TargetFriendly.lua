...
-- SCarfaXX    
	...
	window.W.Effects.ShowLineEff_Checkbox = e
    
    -- Effects - Show Mythic Style Border Label
    e = window.W.Effects( "Label" )
    e:Resize( 450 )
    e:Align( "leftcenter" )
    e:AnchorTo( window.W.Effects.ShowLineEff_Checkbox, "right", "left", 10, 0 )
    e:Font( "font_chat_text" )
    e:SetText( T["Show Line Under Effects"] )
    window.W.Effects.ShowLineEff_Label = e
-- /SCarfaXX
    ...
    e:AnchorTo( window.W.Effects.ShowLineEff_Checkbox, "bottomleft", "topleft", 0, 10 )
    e:Font( "font_chat_text" )
    e:Align( "leftcenter" )
...
function ApplyConfigSettings()
	...
	Pure.Set( "friendly-effects-lineeff", window.W.Effects.ShowLineEff_Checkbox:GetValue() )
...
function RevertConfigSettings()
	...
	window.W.Effects.ShowLineEff_Checkbox:SetValue( Pure.Get( "friendly-effects-lineeff" ) )
