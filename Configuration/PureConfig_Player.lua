...
function ApplyConfigSettings()
	...
	Pure.Set( "player-effects-lineeff", window.W.Effects.ShowLineEff_Checkbox:GetValue() )
...
function RevertConfigSettings()
	...
	window.W.Effects.ShowLineEff_Checkbox:SetValue( Pure.Get( "player-effects-lineeff" ) )
