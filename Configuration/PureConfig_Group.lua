...
function ApplyConfigSettings()
	...
	Pure.Set( "group-effects-lineeff", window.W.Effects.ShowLineEff_Checkbox:GetValue() )
...
function RevertConfigSettings()
	...
	window.W.Effects.ShowLineEff_Checkbox:SetValue( Pure.Get( "group-effects-lineeff" ) )
