...
function ApplyConfigSettings()
	...
	Pure.Set( "hostile-effects-lineeff", window.W.Effects.ShowLineEff_Checkbox:GetValue() )
...
function RevertConfigSettings()
	...
	window.W.Effects.ShowLineEff_Checkbox:SetValue( Pure.Get( "hostile-effects-lineeff" ) )
