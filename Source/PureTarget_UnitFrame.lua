...
function PureTargetUnitFrame:InitializeEffectTracker()
	...
	if( bShow ) then
		...
		local dx, dy, scale, selfCastOnly, effectsAlpha, effectsFontAlpha, effectsMBorder, effectsLine, handleInput
		...
		if( self.m_IsFriendly ) then
			...
			effectsLine		= Pure.Get( "friendly-effects-lineeff" )
			handleInput			= Pure.Get( "friendly-frame-handleinput" )
		else
			...
			effectsLine		= Pure.Get( "hostile-effects-lineeff" )
			handleInput			= Pure.Get( "hostile-frame-handleinput" )
		end
		...
		self.m_effectTracker:Initialize( dx, dy, effectsAlpha, effectsFontAlpha, 10, effectsAlpha / 2, selfCastOnly, showLabels, true, effectsMBorder, effectsLine, handleInput )
	end
end
