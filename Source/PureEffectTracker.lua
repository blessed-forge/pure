...
function PureEffectTracker:Initialize( windowDx, windowDy, frameAlpha, fontAlpha, fadeStartTime, fadeMinAlpha, selfCastOnly, showEffectDurations, showCooldownSpinner, showMythicEffectBorder, showLineEff, handleInput )
    ...
    do
		frame:Initialize( self.m_windowDx, self.m_windowDy, self.m_frameAlpha, self.m_fontAlpha, self.m_fadeStartTime, 
			self.m_fadeMinAlpha, self.m_bShowEffectDurations, self.m_bShowCooldownSpinner, self.m_bShowMythicEffectBorder, self.m_bShowLineEff, self.m_bHandleInput )
	end
end
