...
function PurePlayer.LoadUnitFrame()
  -- Remove player portrait as we don't use it anyways. SCarfaXX 20180409
  WindowSetShowing("PlayerWindow", false)
  if (DoesWindowExist("PetHealthWindow")) then
    WindowSetShowing("PetHealthWindow", false)
  end
  
  WindowSetDimensions ("ChatWindowSocialWindowButton", 10, 10)
  WindowClearAnchors("ChatWindowSocialWindowButton")
  WindowAddAnchor("ChatWindowSocialWindowButton", "topleft", "Root", "topleft", 0, 0)
